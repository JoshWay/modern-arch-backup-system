...
cat > /home/your-username/scripts/restic-env-secure.sh << 'EOF'
#!/bin/bash
...
chmod 755 /home/your-username/scripts/restic-env-secure.sh
chown your-username:your-username /home/your-username/scripts/restic-env-secure.sh
...
echo "  source /home/your-username/scripts/restic-env-secure.sh"
echo ""
